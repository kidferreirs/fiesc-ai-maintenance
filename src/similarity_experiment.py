...
def calculate_metrics(df, sample, neighbor_lists, k):
    ...
    for row_position, neighbors in enumerate(neighbor_lists):
        ...
        real_fault = sample.iloc[row_position]["fault"]
        neighbor_faults = df.loc[neighbor_indices, "fault"]
...
def main():
    print("=" * 90)
    print("FIESC - EXPERIMENTOS DE BUSCA POR SIMILARIDADE")
    print("=" * 90)
    ...
    output_path = reports_dir / "similarity_experiments.csv"
